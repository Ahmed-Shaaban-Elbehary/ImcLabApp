...
{
    public class Tumors_BackUpController : Controller
    {
        ...
        public JsonResult Get_Backup()
        {
            ...
            var data = db.tb_TumorsBackUps.ToList();
...
#pragma warning restore CS0472 // The result of the expression is always the same since a value of this type is never equal to 'null'
            {
                ...
                {
                    var fileInDb = db.tb_TumorsBackUps.Where(t => t.Id == fileId).FirstOrDefault();
                    ...
                    tumors.testName = testName;
                    tumors.Name = fileName;
                    tumors.urlName = fileURL;
                    tumors.Datetime = dateTime;
                    tumors.patients_Id = patientId;
